...
class Konusma{
  ...
  DateTime sonOkunmaZamani; //buna gerek kalmadı
  String aradakiFark;

  Konusma({this.konusma_sahibi, this.kimle_konusuyor, this.goruldu, this.olusturulma_tarihi, this.son_yollanan_mesaj, this.gorulme_tarihi});
